...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\rmetrics.proto\x12\x14io.dnxware.client\"(\n\tLabelPair\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\t\"\x16\n\x05Gauge\x12\r\n\x05value\x18\x01 \x01(\x01\"\x18\n\x07\x43ounter\x12\r\n\x05value\x18\x01 \x01(\x01\"+\n\x08Quantile\x12\x10\n\x08quantile\x18\x01 \x01(\x01\x12\r\n\x05value\x18\x02 \x01(\x01\"e\n\x07Summary\x12\x14\n\x0csample_count\x18\x01 \x01(\x04\x12\x12\n\nsample_sum\x18\x02 \x01(\x01\x12\x30\n\x08quantile\x18\x03 \x03(\x0b\x32\x1e.io.dnxware.client.Quantile\"\x18\n\x07Untyped\x12\r\n\x05value\x18\x01 \x01(\x01\"c\n\tHistogram\x12\x14\n\x0csample_count\x18\x01 \x01(\x04\x12\x12\n\nsample_sum\x18\x02 \x01(\x01\x12,\n\x06\x62ucket\x18\x03 \x03(\x0b\x32\x1c.io.dnxware.client.Bucket\"7\n\x06\x42ucket\x12\x18\n\x10\x63umulative_count\x18\x01 \x01(\x04\x12\x13\n\x0bupper_bound\x18\x02 \x01(\x01\"\xbe\x02\n\x06Metric\x12.\n\x05label\x18\x01 \x03(\x0b\x32\x1f.io.dnxware.client.LabelPair\x12*\n\x05gauge\x18\x02 \x01(\x0b\x32\x1b.io.dnxware.client.Gauge\x12.\n\x07\x63ounter\x18\x03 \x01(\x0b\x32\x1d.io.dnxware.client.Counter\x12.\n\x07summary\x18\x04 \x01(\x0b\x32\x1d.io.dnxware.client.Summary\x12.\n\x07untyped\x18\x05 \x01(\x0b\x32\x1d.io.dnxware.client.Untyped\x12\x32\n\thistogram\x18\x07 \x01(\x0b\x32\x1f.io.dnxware.client.Histogram\x12\x14\n\x0ctimestamp_ms\x18\x06 \x01(\x03\"\x88\x01\n\x0cMetricFamily\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x0c\n\x04help\x18\x02 \x01(\t\x12.\n\x04type\x18\x03 \x01(\x0e\x32 .io.dnxware.client.MetricType\x12,\n\x06metric\x18\x04 \x03(\x0b\x32\x1c.io.dnxware.client.Metric*M\n\nMetricType\x12\x0b\n\x07\x43OUNTER\x10\x00\x12\t\n\x05GAUGE\x10\x01\x12\x0b\n\x07SUMMARY\x10\x02\x12\x0b\n\x07UNTYPED\x10\x03\x12\r\n\tHISTOGRAM\x10\x04\x42\x16\n\x14io.dnxware.client')
)
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

_METRICTYPE = _descriptor.EnumDescriptor(
  name='MetricType',
  full_name='io.dnxware.client.MetricType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_LABELPAIR = _descriptor.Descriptor(
  name='LabelPair',
  full_name='io.dnxware.client.LabelPair',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='io.dnxware.client.LabelPair.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='io.dnxware.client.LabelPair.value', index=1,
...
_GAUGE = _descriptor.Descriptor(
  name='Gauge',
  full_name='io.dnxware.client.Gauge',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='io.dnxware.client.Gauge.value', index=0,
...
_COUNTER = _descriptor.Descriptor(
  name='Counter',
  full_name='io.dnxware.client.Counter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='io.dnxware.client.Counter.value', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_QUANTILE = _descriptor.Descriptor(
  name='Quantile',
  full_name='io.dnxware.client.Quantile',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='quantile', full_name='io.dnxware.client.Quantile.quantile', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='io.dnxware.client.Quantile.value', index=1,
...
_SUMMARY = _descriptor.Descriptor(
  name='Summary',
  full_name='io.dnxware.client.Summary',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='sample_count', full_name='io.dnxware.client.Summary.sample_count', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sample_sum', full_name='io.dnxware.client.Summary.sample_sum', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='quantile', full_name='io.dnxware.client.Summary.quantile', index=2,
...
_UNTYPED = _descriptor.Descriptor(
  name='Untyped',
  full_name='io.dnxware.client.Untyped',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='io.dnxware.client.Untyped.value', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_HISTOGRAM = _descriptor.Descriptor(
  name='Histogram',
  full_name='io.dnxware.client.Histogram',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='sample_count', full_name='io.dnxware.client.Histogram.sample_count', index=0,
      number=1, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='sample_sum', full_name='io.dnxware.client.Histogram.sample_sum', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='bucket', full_name='io.dnxware.client.Histogram.bucket', index=2,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BUCKET = _descriptor.Descriptor(
  name='Bucket',
  full_name='io.dnxware.client.Bucket',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='cumulative_count', full_name='io.dnxware.client.Bucket.cumulative_count', index=0,
      number=1, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='upper_bound', full_name='io.dnxware.client.Bucket.upper_bound', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_METRIC = _descriptor.Descriptor(
  name='Metric',
  full_name='io.dnxware.client.Metric',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='label', full_name='io.dnxware.client.Metric.label', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gauge', full_name='io.dnxware.client.Metric.gauge', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='counter', full_name='io.dnxware.client.Metric.counter', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='summary', full_name='io.dnxware.client.Metric.summary', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='untyped', full_name='io.dnxware.client.Metric.untyped', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='histogram', full_name='io.dnxware.client.Metric.histogram', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='timestamp_ms', full_name='io.dnxware.client.Metric.timestamp_ms', index=6,
...
_METRICFAMILY = _descriptor.Descriptor(
  name='MetricFamily',
  full_name='io.dnxware.client.MetricFamily',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='io.dnxware.client.MetricFamily.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='help', full_name='io.dnxware.client.MetricFamily.help', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='type', full_name='io.dnxware.client.MetricFamily.type', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='metric', full_name='io.dnxware.client.MetricFamily.metric', index=3,
